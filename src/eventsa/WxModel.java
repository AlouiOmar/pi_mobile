...
public class WxModel{
    ...
    public String getTemp(){
        ...
        double tempC1=temp-32;
        double tempC2=tempC1*0.5555555555555556;
        String tempFmt = String.format("%.1f", tempC2);
        return tempFmt;
    } 
    // Speed of wind
    public String getWindSpeed(){
        ...
        double windSpeedK= 1.609344*windSpeed;
        String windSpeedFmt = String.format("%.1f", windSpeedK);
        return windSpeedFmt;
    }
    ...
    public String getPressure(){
        ...
        String pinHgFmt = String.format("%.2f", phPa);
        return pinHgFmt;
    }
