...
public class Event {
    ...
    private Fos_user_1 creator;
    private ArrayList<Fos_user_1> participants;

    public Event(String titre, String dateE, String Description, String region, String nameC, int idE, int nbplaces, Fos_user_1 creator, ArrayList<Fos_user_1> participants) {
        this.titre = titre;
        this.dateE = dateE;
    ...
    public Fos_user_1 getCreator() {
        return creator;
    }

    public void setCreator(Fos_user_1 creator) {
        this.creator = creator;
    }

    public ArrayList<Fos_user_1> getParticipants() {
        return participants;
    }

    public void setParticipants(ArrayList<Fos_user_1> participants) {
        this.participants = participants;
    }
