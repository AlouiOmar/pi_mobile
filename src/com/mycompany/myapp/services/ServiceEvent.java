...
import com.mycompany.myapp.entities.Fos_user_1;
...
public class ServiceEvent {
    ...
    public boolean addEvent(Event ev) {
        String url = Statics.BASE_URL1 + "createevent?titre=" + ev.getTitre() + "&dateE=" + ev.getDateE() + "&description=" + ev.getDescription()+ "&region=" + ev.getRegion() + "&nameC=" + ev.getNameC() +"&nbplaces=" + ev.getNbplaces();
        req.setUrl(url);
        ...
        String url = Statics.BASE_URL1 + "editevent/"+ev.getIdE()+"?titre=" + ev.getTitre() + "&dateE=" + ev.getDateE() + "&description=" + ev.getDescription()+ "&region=" + ev.getRegion() + "&nameC=" + ev.getNameC() +"&nbplaces=" + ev.getNbplaces();
        req.setUrl(url);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
...
//                t.setStatus(((int)Float.parseFloat(obj.get("status").toString())));
    ...
    public ArrayList<Event> afficherEvents(){
        String url = Statics.BASE_URL1+"showevent";
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
    ...
    public boolean deleteEvent(Event ev) {
        String url = Statics.BASE_URL1 + "deleteevent/"+ev.getIdE();
        req.setUrl(url);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
