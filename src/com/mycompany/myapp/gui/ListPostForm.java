...
//            
    ...
    public ListPostForm(Resources res,Form previous,fos_user user)
    { 
     ...
     //   ImageViewer ivLogo=new ImageViewer();
      ...
      //       String image = ev.get(i).getImagename();
       ...
       placeHolder = EncodedImage.createFromImage(res.getImage("Point_d_interrogation.jpg"), false);   
          String url="http://localhost/pi/web/uplods/post/"+ev.getPhoto();
...
//             Image image1=URLImage.createToStorage(null, url, url,URLImage.RESIZE_SCALE);
       ...
       //     Button participer=new Button("Participer");
        ...
        Label nbrating = new Label("Nombre de Rating : "+Integer.toString(ev.getRating()));
                ...
                else 
                {
                  ...
                  new ListPostForm(res,previous,user).show();
       ...
       me.addAll(mtfTitre,mtfDescription,mcnt,btnModifier);
           me.getToolbar().addMaterialCommandToLeftBar("", FontImage.MATERIAL_ARROW_BACK, e-> new HomeForm_1(res, user).show());
             me.show();        
            ...
            cnt2.addAll(img,lbTitre,lbDateE,lbDescription,lbRating,cnt1);
            add(cnt2);
            show();
...
fos_user  Us = new fos_user();
         ...
         //   cnt1.addAll(modifier,details,supprimer);
            cnt2.addAll(lbTitre,lbDateE,lbDescription,lbRating,cnt1);
            f1.add(cnt2);
            f1.show();
...
//               
        ...
        getToolbar().addMaterialCommandToLeftBar("", FontImage.MATERIAL_ARROW_BACK, e1->new HomeForm_1(res,user).show());
