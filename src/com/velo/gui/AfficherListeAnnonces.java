...
/*public class AfficherListeAnnonces extends SideMenuBaseForm{
    ...
    public AfficherListeAnnonces() {
        Resources res= UIManager.initFirstTheme("/theme_1");
...
//                EncodedImage palceHolder = EncodedImage.createFromImage(theme.getImage("round.png").scaled(120, 100), false);
    ...
    public Form getListeAnnoncesForm() {
        return listeAnnoncesForm;
    }

    public void setListeAnnoncesForm(Form listeAnnoncesForm) {
        this.listeAnnoncesForm = listeAnnoncesForm;
    }
