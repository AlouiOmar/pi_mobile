 ...
 * @author Aloui Omar
 */
public class AjouterAnnonce extends SideMenuBaseForm{
   Annonce a=new Annonce();
    ...
    public AjouterAnnonce(Resources res) {
       ...
       //#####begin
//         ajoutAnnonceForm=new Form("Ajouter Annocne",BoxLayout.y());
//        ajoutAnnonceForm.getToolbar().addCommandToSideMenu("Ajouter annonce", null, e->{ajoutAnnonceForm.show();});
//        ajoutAnnonceForm.getToolbar().addCommandToSideMenu("Liste des annonces", null, new ActionListener() {
//
...
//         });
        Label lTitre=new Label("Titre");
        TextField tTitre=new TextField("","Titre");
        tTitre.getStyle().setBgColor(ColorUtil.BLACK);
        Label lType=new Label("Type");
        //TextField tType=new TextField("","Type");
        PickerComponent tType = PickerComponent.createStrings("Vente", "Location").label("Type");
        Label lCategorie=new Label("Catégorie");
...
//                    doSomething();
        ...
        cb.setVisible(false);
        Label lDate=new Label("Date");
        PickerComponent tDate = PickerComponent.createDate(null).label("Date");
        Button bAjouter=new Button("Ajouter annonce");
        ajoutAnnonceForm.addAll(lTitre,tTitre,lCategorie,tCategorie,lGouvernorat,tGouvernorat,lType,tType,lDate,tDate,lPrix,tPrix,lDescriprion,tDescriprion,lPhoto,upload,lTypevelo,tTypevelo,lCouleur,tCouleur,bAjouter,cb);
        bAjouter.addActionListener(e1->{
...
//                 Form listeAnnoncesForm = listeAnnonces.getListeAnnoncesForm();
    ...
    public Form getAjoutAnnonceForm() {
        return ajoutAnnonceForm;
    }

    public void setAjoutAnnonceForm(Form ajoutAnnonceForm) {
        this.ajoutAnnonceForm = ajoutAnnonceForm;
    }
