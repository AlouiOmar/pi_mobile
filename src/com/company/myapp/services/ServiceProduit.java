...
public class ServiceProduit {
    ...
    public static ServiceProduit getInstance() {
     ...
     public boolean addProduit(Produit p,String tp,int user) {
        ...
        req.setUrl("http://127.0.0.1:8000/AddMobile/");
        req.addArgument("nomP",p.getNom_P() );
        req.addArgument("marqueP", p.getMarque_P());
        req.addArgument("categorieP", p.getCategorie_P());
        req.addArgument("couleurP", p.getCouleur_P());
        req.addArgument("prixP", String.valueOf(p.getPrix_P()) );
        req.addArgument("type", tp );
        req.addArgument("photoP", p.getPhoto_P() );
        req.addArgument("tel", String.valueOf(p.getTel()) );
        req.addArgument("userid", String.valueOf(user) );
        ...
        try {
            ...
            for(Map<String,Object> obj : list){
               ...
               p.setTel(((int)Float.parseFloat(obj.get("tel").toString())));
                            Map<String,Object> objuser =(Map<String,Object>) obj.get("id");
//                            System.out.println("id : "+objuser.get("id").toString());
